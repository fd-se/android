...
import com.example.dangerous.dangerousor.util.VideoUtils;
...
//    private boolean isPause; //暂停标识
    ...
    private void initView() {
        ...
        mPauseRecord = findViewById(R.id.record_pause);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    VideoUtils.appendVideo(RecordVideo.this, getSDPath(RecordVideo.this) + "append.mp4", str);
                    File reName = new File(saveVideoPath);
                    File f = new File(getSDPath(RecordVideo.this) + "append.mp4");
            ...
            case R.id.record_control: {
                if (mRecorderState == STATE_INIT) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            finish();
                            Intent intent = new Intent(RecordVideo.this, PlayVideoActivity.class);
                ...
                if (mRecorderState == STATE_RECORDING) {
                    ...
                    mCamera.autoFocus(new Camera.AutoFocusCallback() {
                        ...
                        public void onAutoFocus(boolean success, Camera camera) {
                            if (success)
                                RecordVideo.this.mCamera.cancelAutoFocus();
                        }
                    });
...
//        mediaRecorder.setAudioChannels(2);
    ...
    public static String getSDPath(Context context) {
        ...
        File eis = new File(sdDir + "/RecordVideo/");
        if (!eis.exists()) {
            eis.mkdir();
        }
        return sdDir + "/RecordVideo/";
    }
